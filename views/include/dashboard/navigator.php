<nav class="leftMenu">
  ...
  <div class="wrapMenu">
    <ul class="menu">
      ...
      <a href="gestion-noticias"><li><i class="fab fa-blogger"></i><div class="item">blog</div></li></a>
      <a href="gestion-videos"><li><i class="fas fa-play"></i><div class="item">videos</div></li></a>
      <a href="ver-pedidos-hechos"><li><i class="fas fa-archive"></i><div class="item">Pedidos</div></li></a>
      <a href="ver-usuarios-registrados"><li><i class="fas fa-user"></i><div class="item">Usuarios</div></li></a>
    </ul>
  </div>
</nav>
